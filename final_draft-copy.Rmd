...
df_summary_race$`Race/Ethnicity` <- factor(df_summary_race$`Race/Ethnicity`, levels = c("Asian", "Other", "2 or more races", "Non-Hispanic White", "Hawaiian/Pacific Islander", "American Indian/Alaska Native", "Hispanic", "Non-Hispanic Black"))
```
...
```{r}
ggplot(df_year, aes(x=YearEnd, y=Data_Value_Alt, group=`Race/Ethnicity`, color=`Race/Ethnicity`)) +
  geom_line() +
  theme_minimal() +
